...
class SecurityUtilsUnitTest {
    ...
    void testHasCurrentUserAnyOfAuthorities() {
        ...
        Boolean hasCurrentUserThisAuthority = SecurityUtils
            .hasCurrentUserAnyOfAuthorities(AuthoritiesConstants.PATIENT, AuthoritiesConstants.ADMIN)
    ...
    void testHasCurrentUserNoneOfAuthorities() {
        ...
        Boolean hasCurrentUserThisAuthority = SecurityUtils
            .hasCurrentUserNoneOfAuthorities(AuthoritiesConstants.PATIENT, AuthoritiesConstants.ADMIN)
            .contextWrite(context)
            .block();
        assertThat(hasCurrentUserThisAuthority).isFalse();
    ...
    void testHasCurrentUserThisAuthority() {
        ...
        Boolean hasCurrentUserThisAuthority = SecurityUtils
            .hasCurrentUserThisAuthority(AuthoritiesConstants.PATIENT)
            .contextWrite(context)
            .block();
        assertThat(hasCurrentUserThisAuthority).isTrue();
