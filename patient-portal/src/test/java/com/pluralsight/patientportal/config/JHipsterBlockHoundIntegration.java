...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.pluralsight.patientportal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.pluralsight.patientportal.security.DomainUserDetailsService", "createSpringSecurityUser");
