...
import com.pluralsight.patientportal.repository.EntityManager;
...
class UserResourceIT {
    ...
    void getAllUsers() {
        ...
        userRepository.save(user).block();
        authorityRepository
            .findById(AuthoritiesConstants.PATIENT)
        ...
        assertThat(foundUser.getAuthorities()).containsExactly(AuthoritiesConstants.PATIENT);
    }
    ...
    void getUser() {
        ...
        webTestClient
            ...
            .isEqualTo(AuthoritiesConstants.PATIENT);
    }
